...
Messages.quit = "Chcete skutečně skončit?"
Messages.username_prompt = "zadejte své uživatelské jméno"
Messages.enter_password = "zadejte heslo"
Messages.enter_import_password = "zadejte heslo pro import"
Messages.incorrect_password = "neplatné heslo"
Messages.repeat_password = "opakujte zadání hesla"
Messages.passwords_differ = "heslo není shodné"
Messages.installation_finished = "Instalace proběhla úspěšně"
Messages.cat_dir_exisits = "Adresář {} už existuje, některé " \
                           "soubory v něm budou přepsány."
Messages.cont = "Pokračovat?"
Messages.nm_not_supported = "Tato verze NetworkManageru není " \
                            "podporována"
Messages.cert_error = "Soubor s certifikátem nebyl nalezen, " \
                      "pravděpodobně je to chyba CAT"
Messages.unknown_version = "Neznámá verze"
Messages.dbus_error = "Problém připojení k DBus, příkaz sudo vám " \
                      "může pomoci"
Messages.yes = "A"
Messages.no = "N"
Messages.p12_filter = "soubor osobního certifikátu (p12 nebo pfx)"
Messages.all_filter = "Všechny soubory"
Messages.p12_title = "soubor osobního certifikátu (p12 nebo pfx)"
Messages.save_wpa_conf = "Konfigurace NetworkManageru se nezdařila. " \
                         "Pokud si přejete, můžeme vygenerovat konfigurační soubor pro " \
                         "wpa-supplicant. Vaše heslo pro připojení bude v tomto souboru " \
                         "uloženo v textové podobě!"
Messages.save_wpa_confirm = "Zapsat soubor"
Messages.wrongUsernameFormat = "Chyba: Vaše uživatelské jméno " \
                               "musí být ve formátu 'jméno@institutionID', např. " \
                               "'john@example.net'!"
Messages.wrong_realm = "Chyba: Vaše uživatelské jméno musí být " \
                       "ve formátu 'jméno@{}'. Zadejte prosím uživatelské jméno ve " \
                       "správném formátu."
Messages.wrong_realm_suffix = "Chyba: Vaše uživatelské jméno musí " \
                              "být ve formátu 'jméno@institutionID' a končit s '{}'. Zadejte " \
                              "prosím uživatelské jméno ve správném formátu."
Messages.user_cert_missing = "soubor s osobním certifikátem nebyl " \
                             "nalezen"
Config.instname = "České vysoké učení Technické v Praze"
Config.profilename = "cvut.cz"
Config.url = "https://ist.cvut.cz/nase-sluzby/eduroam/"
Config.email = "vaše uživatelská podpora eduroam®"
Config.title = "eduroam CAT"
Config.server_match = "radius.cvut.cz"
Config.eap_outer = "PEAP"
Config.eap_inner = "MSCHAPV2"
Config.init_info = "Tento instalační program byl připravený pro " \
                   "{0}\n\nDalší informace a komentáře:\n\nEMAIL: {1}\nWWW: " \
                   "{2}\n\nInstalační program byl vytvořený pomocí programu z " \
                   "projektu GEANT."
Config.init_confirmation = "Tento instalační program bude fungovat " \
                           "pouze pokud jste členem organizace {0}."
Config.user_realm = "cvut.cz"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.cvut.cz']
